...
private:
    ...
    void descending(Node<T> *root) const
    {
        if (root != nullptr)
        {
...
int main()
{
    ...
    else if (chooseDataStructure == 2)
    {
        cout << "1 - name" << endl;
        cout << "2 - price" << endl;
        cin >> sortBy;
        compareWay = sortBy;
        av.insert(Item("qeb", "cafe", 321));
        av.insert(Item("adfo", "cafe", 321));
        av.insert(Item("ggad", "cafe", 321));
        av.insert(Item("ao", "cafe", 321));
        av.inOrder();
    }
